...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:07111F,50:0B3B4A,100:00B8A9&height=230&section=header&text=Manoj%20Kumar&fontSize=46&fontColor=E6FFFB&animation=fadeIn&fontAlignY=38&desc=B.Tech%20CSE%20Student%20%7C%20Web%20Developer%20%7C%20AI%2FML%20Enthusiast&descAlignY=60&descSize=17" width="100%"/>

<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=23&duration=3000&pause=900&color=00D9C0&center=true&vCenter=true&width=720&lines=Building+Modern+Web+Applications;Learning+AI%2FML+%26+Cyber+Security;Python+%7C+JavaScript+%7C+React+%7C+SQL;Turning+Ideas+Into+Real+Projects" alt="Typing SVG" /></a>
...
- 🚀 Building projects with React, JavaScript, Python, HTML, CSS and SQL
- 🌱 Continuously learning and improving my problem-solving skills
- 🤝 Open to internships, hackathons, collaborations and project opportunities
...
|---|---|---|
| 🏥 **MYCARE** | Medical assistance platform concept with patient/doctor interaction, report scanning and appointment support. | React, AI, Supabase |
| 📱 **AI Mobile Store** | AI-powered mobile shopping platform with recommendations, chatbot, search and delivery features. | React, Node.js, MongoDB |
| 🌾 **Village Development** | Village information, local marketplace, community and agriculture-focused digital platform. | React, Supabase, AI |
| 🏫 **TRINITY High School** | Modern school website with events, gallery, study, sports and communication modules. | React, Vite, Tailwind |
| 💻 **ManojCodeTech** | Personal coding/project playground for experimenting with web development ideas. | HTML, CSS, JavaScript |
...
`AI / ML` &nbsp; `Web Development` &nbsp; `Cyber Security` &nbsp; `Data Science` &nbsp; `Software Engineering`
...
Git & Deployment      █████████████░░░░░  GitHub + Vercel + Cloud
```
...
> **Note:** Replace the LinkedIn button URL with your exact LinkedIn profile URL when you have it.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00B8A9,50:0B3B4A,100:07111F&height=120&section=footer" width="100%"/>
